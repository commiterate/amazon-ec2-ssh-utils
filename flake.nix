    ...
    // (
      ...
      in
      {
        ...
        packages = genSystemAttrs (
          system: developmentInputs.nixpkgs.legacyPackages.${system}.amazon-ec2-ssh-utils.packages
        );
        ...
        devShells = genSystemAttrs (
          system: developmentInputs.nixpkgs.legacyPackages.${system}.amazon-ec2-ssh-utils.devShells
        );
        ...
        systemConfigs =
          ...
          inputs.nixpkgs.lib.filesystem.packagesFromDirectoryRecursive {
            ...
            callPackage = inputs.nixpkgs.lib.customisation.callPackageWith { inputs = developmentInputs; };

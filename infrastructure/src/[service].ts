...
const selfNixFlakeReference = utils_nix.getFlakeInput(
	nixFlakeMetadata,
	"self"
) as utils_nix.FlakeReference<utils_nix.FlakeType.GIT>;

export const selfNixFlakeRevision: string = (selfNixFlakeReference.rev ??
	selfNixFlakeReference.dirtyRev) as string;
